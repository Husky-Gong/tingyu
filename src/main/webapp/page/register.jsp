...
<head>
    ...
    <script type="text/javascript" src="page/js/jquery-1.12.3.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function getCode(){
            ...
            $.ajax({
                type:"POST",
                url:"AdminController/phone", //调用java后台代码发送验证码
                async: false,
           ...
           <div style="margin-left: 200px;margin-top: 60px">
             ...
             <form>
                 ...
                 <div>
                     ...
                     <input class="t" type="text" id="phonenumber" />
                 </div>
                 ...
                 <div>
                     ...
                     <input class="t" type="text" style="width: 130px" />
